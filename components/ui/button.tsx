...
const buttonVariants = cva(
  "inline-flex items-center justify-center whitespace-nowrap rounded-md text-sm font-bold transition-colors focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring disabled:pointer-events-none disabled:opacity-50",
  {
    variants: {
      variant: {
        default: "bg-adm-primary text-adm-contrast hover:bg-adm-primary/90 border-2 border-adm-primary",
        destructive:
          "bg-destructive text-destructive-foreground hover:bg-destructive/90",
        outline:
          "border-2 border-adm-primary text-adm-primary bg-transparent hover:bg-adm-primary hover:text-adm-contrast",
        secondary:
